...
import { LayoutDashboard, Building2, CreditCard, Settings, AlertCircle, Inbox, Smartphone } from 'lucide-react';
...
const NAV = [
  ...
  { path: '/super-admin/early-access', label: 'Early Access', icon: Smartphone },
];
